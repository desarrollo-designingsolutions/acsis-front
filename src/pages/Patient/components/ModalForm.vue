            ...
            <VCard :disabled="loading.form" :loading="loading.form">
                ...
                <VCardText>
                    <VForm ref="formValidation" @submit.prevent="() => { }" :disabled="disabledFiledsView">
                        <VRow>
                            <VCol cols="12" sm="4">
                                <AppSelectRemote :show="disabledFiledsView" label="Tipo de Documento"
                                    v-model="form.tipo_id_pisi_id" url="/selectInfiniteTipoDocumento"
                                    arrayInfo="tipoIdPisiss" :requiredField="true" :rules="[requiredValidator]"
                                    clearable>
                                </AppSelectRemote>
                            </VCol>

                            <VCol cols="12" sm="4">
                                <AppTextField :requiredField="true" :rules="[requiredValidator]" clearable
                                    v-model="form.document" label="Documento" :error-messages="errorsBack.document" />
                            </VCol>

                            <VCol cols="12" sm="4">
                                <AppSelectRemote :show="disabledFiledsView" label="Tipo de Usuario"
                                    v-model="form.rips_tipo_usuario_version2_id" url="/selectInfiniteTipoUsuario"
                                    arrayInfo="ripsTipoUsuarioVersion2s" :requiredField="true"
                                    :rules="[requiredValidator]" clearable>
                                </AppSelectRemote>
                            </VCol>

                            <VCol cols="12" sm="4">
                                <AppTextField clearable type="date" :requiredField="true"
                                    :error-messages="errorsBack.birth_date" :rules="[requiredValidator]"
                                    v-model="form.birth_date" label="Fecha de Nacimiento"
                                    @input="errorsBack.birth_date = ''" />
                            </VCol>

                            <VCol cols="12" sm="4">
                                <AppSelectRemote :show="disabledFiledsView" label="Sexo" v-model="form.sexo_id"
                                    url="/selectInfiniteSexo" arrayInfo="sexos" :requiredField="true"
                                    :rules="[requiredValidator]" clearable>
                                </AppSelectRemote>
                            </VCol>

                            <VCol cols="12" sm="4">
                                <AppSelectRemote :show="disabledFiledsView" label="Pais de Residencia"
                                    v-model="form.pais_residency_id" url="/selectInfinitePais" arrayInfo="paises"
                                    :requiredField="true" :rules="[requiredValidator]" clearable>
                                </AppSelectRemote>
                            </VCol>

                            <VCol cols="12" sm="4">
                                <AppSelectRemote :show="disabledFiledsView" label="Municipio de Residencia"
                                    v-model="form.municipio_residency_id" url="/selectInfiniteMunicipio"
                                    arrayInfo="municipios" :requiredField="true" :rules="[requiredValidator]" clearable>
                                </AppSelectRemote>
                            </VCol>

                            <VCol cols="12" sm="4">
                                <AppSelectRemote :show="disabledFiledsView" label="Zona Territorial de Residencia"
                                    v-model="form.zona_version2_id" url="/selectInfiniteZonaVersion2"
                                    arrayInfo="zonaVersion2s" :requiredField="true" :rules="[requiredValidator]"
                                    clearable>
                                </AppSelectRemote>
                            </VCol>
                            ...
                            <VCol cols="12" sm="4">
                                <AppSelectRemote :show="disabledFiledsView" label="Pais de Origen"
                                    v-model="form.pais_origin_id" url="/selectInfinitePais" arrayInfo="paises"
                                    :requiredField="true" :rules="[requiredValidator]" clearable>
                                </AppSelectRemote>
                            </VCol>
                            ...
                            <VCol cols="12" sm="4">
                                <AppTextField :requiredField="true" :rules="[requiredValidator]" clearable
                                    v-model="form.first_name" label="Primer Nombre"
                                    :error-messages="errorsBack.first_name" />
                            </VCol>

                            <VCol cols="12" sm="4">
                                <AppTextField :requiredField="true" :rules="[requiredValidator]" clearable
                                    v-model="form.second_name" label="Segundo Nombre"
                                    :error-messages="errorsBack.second_name" />
                            </VCol>

                            <VCol cols="12" sm="4">
                                <AppTextField :requiredField="true" :rules="[requiredValidator]" clearable
                                    v-model="form.first_surname" label="Primer Apellido"
                                    :error-messages="errorsBack.first_surname" />
                            </VCol>

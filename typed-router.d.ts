...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'glosa-components-modal-list-glosa': RouteRecordInfo<'glosa-components-modal-list-glosa', '/Glosa/Components/ModalListGlosa', Record<never, never>, Record<never, never>>,
    ...
    'invoice-payment-components-modal-form-masive': RouteRecordInfo<'invoice-payment-components-modal-form-masive', '/InvoicePayment/Components/ModalFormMasive', Record<never, never>, Record<never, never>>,
    'invoice-payment-components-modal-list-invoice-payment': RouteRecordInfo<'invoice-payment-components-modal-list-invoice-payment', '/InvoicePayment/Components/ModalListInvoicePayment', Record<never, never>, Record<never, never>>,
    'modal-form-service': RouteRecordInfo<'modal-form-service', '/ModalFormService', Record<never, never>, Record<never, never>>,
    ...
    'second-page copy': RouteRecordInfo<'second-page copy', '/second-page copy', Record<never, never>, Record<never, never>>,
